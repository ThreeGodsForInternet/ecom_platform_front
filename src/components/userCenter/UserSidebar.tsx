...
const menuItems = [
  ...
  { id: 'customer-service', label: '客户中心', icon: MessageSquare, path: '/user/customer-service' },
...
export default function UserSidebar() {
  ...
  // 找到当前激活的菜单项
  const activeMenu = menuItems.find(item => currentPath.startsWith(item.path)) || menuItems[0];
